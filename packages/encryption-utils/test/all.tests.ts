...
const sender = {
  publicKey: new Uint8Array([
    250, 121, 196, 219, 20, 87, 6, 49, 23, 10, 171, 230, 116, 229, 145, 253, 64, 230, 27, 241, 50,
    211, 89, 159, 31, 110, 122, 60, 26, 119, 249, 25,
  ]),
  privateKey: new Uint8Array([
    120, 241, 232, 72, 29, 72, 216, 184, 73, 15, 211, 142, 107, 55, 217, 183, 238, 163, 73, 0, 148,
    25, 121, 205, 153, 51, 245, 42, 111, 169, 208, 28,
  ]),
};

const recipient = {
  publicKey: new Uint8Array([
    140, 136, 68, 36, 185, 64, 46, 58, 2, 208, 196, 7, 211, 230, 219, 148, 97, 139, 32, 224, 182,
    163, 10, 100, 11, 131, 158, 10, 49, 67, 167, 33,
  ]),
  privateKey: new Uint8Array([
    185, 136, 27, 24, 181, 160, 214, 62, 16, 177, 159, 30, 193, 150, 146, 129, 235, 108, 98, 97, 31,
    209, 7, 124, 115, 208, 157, 223, 7, 142, 13, 124,
  ]),
};
