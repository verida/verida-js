  ...
  describe('Document creation', function () {
    ...
    it('can add a context', async function () {
      ...
      function validateServiceEndpoint(type, endpointUri, actual: ServiceEndpoint) {
        assert.equal(
          actual.id,
          `did:vda:0xb194a2809b5b3b8aae350d85233439d32b361694?context=0x2d23fba7467f275904b4bc474c816ff37056ae8436ddfc555747613945034a91#${type}`,
          'Endpoint ID matches hard coded value'
        );
