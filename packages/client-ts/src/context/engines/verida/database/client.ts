...
export default class DatastoreServerClient {
    ...
    public async createUser() {
        if (!this.account) {
            throw new Error('Unable to create storage account. No Verida account connected.')
        }
    ...
    public async createDatabase(did: string, databaseName: string, config: any = {}) {
    ...
    public async updateDatabase(did: string, databaseName: string, config: any = {}) {
